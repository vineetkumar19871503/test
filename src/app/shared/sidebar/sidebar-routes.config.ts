...
export const ROUTES: RouteInfo[] = [
    ...
    // { path: '/bills/list', title: 'Billing', icon: 'ft-navigation', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },

    // {
    //     path: '', title: 'Jobs', icon: 'ft-file-text', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false, submenu: [
    //         { path: '/jobs/add', title: 'Add Job', icon: 'ft-file', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] }
    //         // { path: '/jobs/dispatch-job', title: 'Dispatch Job', icon: 'ft-file', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] }
    //     ]
    // }
    // { path: '/jobs/running', title: 'Running Jobs', icon: 'ft-file', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] }
    // {
