...
export class ViewQuoteComponent implements OnInit {
  ...
  private url: string = environment.apiUrl + 'quotes/view';
  ...
  ngOnInit() {
    ...
    self.editQuoteForm = new FormGroup({
      ...
      'quote_name': new FormControl({ value: null, disabled: true }, [Validators.required]),
      ...
      'material': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'bill_type': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'truck_details': self._fb.array([]),
      'status': new FormControl({ value: null, disabled: true }, [Validators.required]),
      'documents': new FormControl(),
      'document_value': new FormControl({ value: null, disabled: true }, [Validators.required])
    });
  ...
  private _getQuoteDetails() {
    const self = this,
      url = environment.apiUrl + 'quotes/view?id=' + this._id;
    self.loading = true;
    ...
    self.truckTypes.forEach(function (truckType: any, i) {
      ...
      (<FormArray>self.editQuoteForm.get('truck_details')).push(
        new FormGroup({
          ...
          'weekdays': new FormControl({ value: wd, disabled: true }, [Validators.required]),
          'saturday': new FormControl({ value: st, disabled: true }, [Validators.required]),
          'sunday': new FormControl({ value: sd, disabled: true }, [Validators.required])
        })
      );
    });
  }
